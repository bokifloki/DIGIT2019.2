  ...
  mk: {
    ...
    homepage: {
      ...
      statisticInformation: {
        ...
        h1: `663 милиони луѓе низ светот живеат без чиста вода.`,
        p1: ` Тоа се речиси 1 во 10 луѓе низ светот, или два пати популацијата на 
        Америка. Повеќето живеат во изолирани рурални населби и го поминуваат по неколку саати дневно одејќи за да соберат вода за својата фамилија.
        Не само што пешачењето ги им одзема од можноста да одат на школо или можноста нивните родители да спечалат пари, четопати и опасноста од
        заразни болести е присутна која моќе сите да ги разболи.`,
